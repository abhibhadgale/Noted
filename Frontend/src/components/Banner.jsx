        ...
        <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10 ">
            <div className='w-full md:order-1 order-2 md:w-1/2 mt-12 md:mt-32'>
                <div className='space-y-12'>
                    ...
                    <p className='text-xl'>
                        Lorem, ispum dolor sit amet consectuer adipisiciong elit.Dolr, et totam. Tempora amet atque expedia, quea corrupite totam sed partitaur corporis at venium esy amet atue experdia, quea volutas anim!
                    </p>
